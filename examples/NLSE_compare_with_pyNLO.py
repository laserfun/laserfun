...
# considerring dudley's values for raman calculrations
custom_raman = "dudley"
...
t_start = time.time()
pulse_pynlo = pynlo.light.DerivedPulses.SechPulse(
    power=1,
    T0_ps=FWHM / 1.76,
    center_wavelength_nm=pulseWL,
    time_window_ps=Window,
...
y, AW, AT, pulse_out = evol.propagate(
    pulse_in=pulse_pynlo, fiber=fiber_pynlo, n_steps=Steps
)
