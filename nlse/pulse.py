...
class Pulse:
    """Class which carries all of the information for a laser pulse."""
    ...
    def __init__(self, pulse_type='sech', center_wavelength_nm=1550, 
                 ...
                 GDD=0, TOD=0):
        """ Generate a new pulse object based on a pre-defined pulse type.
        ...
        ----------
        pulse_type : string
            This determines the shape of the pulse in the time domain. The 
            options are:
            ...
            gaussian, which produces a Gaussian shaped pulse
                 A(t) = sqrt(peak_power) * exp( -(t/T0)^2 / 2 ) 
            sinc, which uses a sin(x)/x (sinc) function, where T0 = fwhm/1.76
                 A(t) = sqrt(peak_power) * sin(t/T0)/(t/T0), were T0 = fwhm/3.79
        center_wavelength_nm : float
            this is the center wavelength of the pulse in nm
        fwhm_ps : float
            this is the full-width-at-half-maximum of the pulse in picoseconds
    ...
    def at(self):
        ...
        energy per time bin when the absolute value is squared."""
